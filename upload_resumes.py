...
client = MongoClient("mongodb://Dev-Admin:%s@pickhacks-shard-00-00-alesk.mongodb.net:27017,pickhacks-shard-00-01-alesk.mongodb.net:27017,pickhacks-shard-00-02-alesk.mongodb.net:27017/test?ssl=true&replicaSet=PickHacks-shard-0&authSource=admin&retryWrites=true&w=majority" % pw)
db = client.test
